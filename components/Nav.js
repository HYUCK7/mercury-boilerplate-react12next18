...
export function Nav(){
  ...
  useEffect(() => {
    ...
    if (loginUser === null) {
      ...
      setUserUrls(["/user/logout","/user/profile","/user/updateUser","/user/delUser","user/getUsers"])
  ...
  const boardUrls = ["/board/addArticle","/board/getArticles","/board/updateArticle","/board/removeArticle"]
